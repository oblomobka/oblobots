// Trunk and arms shaft shaft [OBLOBOTS] v.12
// form + union
...
use <trunk_shaft.scad>
use <arm_shaft.scad>

// Módulos

module trunkandarms_quadrangle_shaft (	T=1,	
                                        trunk=[45,22,45],	
                                        arm=[18,10,2,80],
                                        hand=[25,6,8],
                                        pin=DOWEL_6,	
	...
	if(T<=1){	
		...
		translate([0,y_trunk/2,z_trunk-d_badge/2-2.5-badgeposition[0]])
			rotate([0,aux_angle/n_badge-badgeposition[1],0])
					badge_family_shaft (	units=badgeunits,
									badge=badge,
									pin=pin,
...
module trunkandarms_cylindrical_shaft (	trunk=[40,35,50],	
                                        shoulder=[20,5,3],
                                        arm=[20,8,3,65],
                                        hand=[20,6,180],	
                                        pin=DOWEL_6,
...
translate([i/2,0,0])
trunkandarms_quadrangle_shaft (		T=1,	
                                    trunk=[55,25,45],	
                                    arm=[18,10,2,80],
                                    hand=[25,6,8],
                                    pin=DOWEL_6,	
...
translate([-5*i/2,0,0])
trunkandarms_cylindrical_shaft (		trunk=[40,35,50],	
                                        shoulder=[22,5,3],
                                        arm=[22,6,1,65],
                                        hand=[20,6,180],	
                                        pin=DOWEL_6,
