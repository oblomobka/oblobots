...
translate([145,0,0])
	legs_cylindrical_shaft(	hip=[50,15,100],
							leg=[12,45,100],
							foot=[32,4],
							pin=DOWEL_6,
							play=0,
...
translate([-245,0,0])
	legs_quadrangle_shaft(	x_hip=50,
							leg=[12,35,7,70],
							pin=DOWEL_6,
							foot=[40,6],
							play=0,	
...
translate([-165,0,0])
	legs_quadrangle_shaft(	x_hip=55,
							leg=[15,60,5,100],
							pin=DOWEL_8,
							foot=[35,6],
							play=0,	
